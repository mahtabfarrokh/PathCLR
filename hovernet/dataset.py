...
class __MoNuSAC(__AbstractDataset):
    """Defines the MoNuSAC dataset as originally introduced in:
    """
    print("Here!")
    def load_img(self, path):
    ...
    def load_ann(self, path, with_type=False):
        # assumes that ann is HxW
        print("Loading the annotation:", path)
        
        ann_inst = sio.loadmat(path)["mydata"]
        print("attention:", with_type)
