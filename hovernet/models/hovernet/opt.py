...
#                         "pretrained": "./pretrained/hovernet_fast_pannuke_type_tf2pytorch.tar",
# #                         'pretrained': None,
#                     },
#                 },
#                 "target_info": {"gen": (gen_targets, {}), "viz": (prep_sample, {})},
#                 "batch_size": {"train": 12, "valid": 12,},  # engine name : value
#                 "nr_epochs": 10,
#             },
            {
                "run_info": {
                    ...
                    "net": {
                        ...
                        # path to load, -1 to auto load checkpoint from previous phase,
                        # None to start from scratch
                        "pretrained": "./pretrained/net_epoch20.tar",
                    },
                },
                "target_info": {"gen": (gen_targets, {}), "viz": (prep_sample, {})},
