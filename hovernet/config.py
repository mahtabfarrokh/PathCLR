...
class Config(object):
    ...
    def __init__(self):
        ...
        self.train_dir_list = [
            "./dataset/training_data/monusac/augmented_monusac/valid"
        ]
        self.valid_dir_list = [
            "./dataset/training_data/monusac/augmented_monusac/small_valid_npy"
        ]
        ...
        print("config.py:", nr_type, model_mode)
