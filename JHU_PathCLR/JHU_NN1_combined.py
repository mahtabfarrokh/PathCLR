...
def evaluate_NN(model, resolution, image_num_validation, case_id_validation, labels_validation, embedding_validation):
    ...
    # tn, fp, fn, tp = confusion_matrix(labels_validation, y_pred_f).ravel()
    # tn_sum += tn
    # fn_sum += fn
    # tp_sum += tp
    # fp_sum += fp
    # accuracy = (tp + tn ) / len(y_pred_f)
...
# p1 = "./JHU_trainedOnCPCTR_40x_HR2_sampled_200_128x128_ALL_pretrained.npy"
# p2 = "./JHU_trainedOnCPCTR_40x_HR_sampled_200_128x128_ALL_pretrained.csv"
# p1 = "./JHU_train_40x_HR2_sampled_200_128x128_pretrained.npy"
# p2 = "./JHU_train_40x_HR_sampled_200_128x128_pretrained.csv"
# p1 = "./JHU_train_40x_HR2_sampled_200_128x128_pretrained_fixedcombined.npy"
# p2 =  "./JHU_train_40x_HR_sampled_200_128x128_pretrained_fixedcombined.csv"
p1 = "./JHU_train_40x_HR2_sampled_200_128x128_ALL_pretrained.npy"
p2 = "./JHU_train_40x_HR_sampled_200_128x128_ALL_pretrained.csv"
...
print(embedding_train[0][-10:])
print("-")
print(embedding_train[1][-10:])
print(">>>>>>>>>>>>>>>>>>>>>>")
# labels_train = np.reshape(labels_train, (labels_train.shape[0], 1))
all_labels = labels_train
all_embedding = embedding_train
all_image_num = image_num_train
case_id_train = np.array(case_id_train)
# case_id_train = np.reshape(case_id_train, (case_id_train.shape[0], 1))
all_case_id = case_id_train
...
for train_index, test_index in skf.split(df2["caseID"], df2["label"]):
    ...
    save_results(val_acc_all, "./combined_fixed_accs")




tmp = pd.read_csv(open("./combined_fixed_accs" + str(num) + ".csv", 'rb'))
best  = 0
f_e = 0
f_c = 0
all_avgs = []
...
# kfold_caseid_validation = kfold_caseid_validation.transpose()
# save_results(kfold_caseid_validation, "./kfold_caseid_validation")
...
precision = (tp_sum*1.0) / (tp_sum + fp_sum)
recall = (tp_sum*1.0) / (tp_sum + fn_sum)
