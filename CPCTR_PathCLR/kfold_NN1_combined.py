...
p1 = "./train_40x_HR2_sampled_200_128x128_ALL_pretrained_fixedcombined.npy"
p2 = "./train_40x_HR_sampled_200_128x128_ALL_pretrained_fixedcombined.csv"
image_num_train, case_id_train, labels_train, embedding_train = read_data(project_path, p1, p2)

p1 = "./validation_40x_HR2_sampled_200_128x128_ALL_pretrained_fixedcombined.npy"
p2 = "./validation_40x_HR_sampled_200_128x128_ALL_pretrained_fixedcombined.csv"
...
for train_index, test_index in skf.split(df2["caseID"], df2["label"]):
    ...
    save_results(val_acc_all, "./combined_accs")




tmp = pd.read_csv(open("./combined_accs" + str(num) + ".csv", 'rb'))
best  = 0
f_e = 0
f_c = 0
all_avgs = []
